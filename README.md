...
2. Fill in all the missing text. Don't forget to translate "web_footer.png", too!
   Refer to the comics in "comics-en" for the original, and refer to
   /design-resources to see & install the fonts you'll need.
